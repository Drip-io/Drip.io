...
import com.dripio.data.dao.ExpenseDataAccessObject
...
@Database(
    entities = [EntityPaymentMethod::class, EntityPayment::class, EntityCategory::class, EntityExpense::class],
    version = 1
)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun expenseDataAccessObject(): ExpenseDataAccessObject
